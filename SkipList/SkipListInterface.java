...
public interface SkipListInterface<T extends Comparable<? super T>> {
     ...
     *
     * @param data
     *            an item that is equal to some other item in the skip list
    ...
    /**
     * Adds a new item into the skip list. If there is already data in the list
     * that is equal to the given data, replace the previous data with the new
     * one
     *
     * @param data
     *            the item to put into the skip list
     * @throws IllegalArgumentException
    ...
    /**
     * Removes a item from the skip list. Note that if you remove the only item
     * in a level, you should remove the entire level.
     *
     * @param data
     *            an item that is equal to some other item in the skip list
     * @throws java.util.NoSuchElementException
     *             if the item is not in the skip list.
     * @throws IllegalArgumentException
     *             if the parameter is null
     ...
     *
     * @param data
     *            a item that is equal to some other item in the skip list
     * @throws IllegalArgumentException
     *             if the parameter is null
     * @throws java.util.NoSuchElementException
     *             if the item is not in skip list
    ...
    /**
     * Gets the head of the skip list. This is for grading purposes only. You
    ...
    /**
     * This method will allow you to see what your SkipList looks like. It is
